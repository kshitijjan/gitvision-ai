...
export const aiSummariseCommit = async (diff: string) => {
    const response = await model.generateContent([
        ...
        \`\`\`
        * Raised the amount of returned recording from \`10\` to \`100\` [package/server/recording_api.ts], [package/server/contrast.ts]
        * Fixed a typo in the github action name [.github/workflows/gpt-commit-summarizer.yml]
        * Moved the \`octokit\` initialization to a seperate file [src/octokit.ts], [src/index.ts]
        * Added an OpenAI API for completions [package/utils/apis/openai.ts]
